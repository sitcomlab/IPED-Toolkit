    ...
    function(Backbone, Locations, Videos, Overlays, bootbox) {
        ...
        LocationEditView = Backbone.View.extend({
            ...
            fetch: function() {
                ...
                **/
                ...
                for (var i = 0; i < thiz.model.attributes.relatedLocations.length; i++) {
                    this.relatedLocations.push(new Location(thiz.model.attributes.relatedLocations[i]));
                }

                console.warn(this.relatedLocations);
            ...
            events: {
                ...
                //'click button.add-intents': '_addIntents',
                //'click button.edit-intents': '_editIntents',
                //'click button.delete-intents': '_deleteIntents',
