...
function loadButtons(videoId) {
    ...
    for (var i = 0; i < json.length; i++) {
        $("#buttons")
            .append('<a href="#" class="ui-btn" onclick="setCurrentId(' + json[i].id + '); loadVideoCommand(' + json[i].id + ');">Navigate to ' + json[i].name + '</a>');
    }
...
function loadDescription(id) {
    ...
    $("#video-info p #description")
        .html('<b>Description: </b><br><br>' + video.description + '<br><br><hr><br>' + '<table>' + '<tr><td><b>Video-ID: </b></td><td>' + video._id + '</td></tr>' + '<tr><td><b>GPS-Coordinates: </b></td><td>' + video.gps + '</td></tr>' + '<tr><td><b>Video-URL: </b></td><td>' + video.url + '</td></tr>' + '<tr><td><b>Tags: </b></td><td>' + video.tags + '</td></tr>' + '</table>');
