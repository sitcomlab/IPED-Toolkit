...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		on <?js= (that.moment().format(that.navOptions.dateFormat)) ?> using the <a href="https://github.com/terryweiss/docstrap">DocStrap template</a>.
		</span>
				</footer>
			</div>
	...
	<script>
		$( function () {
			...
			Sunlight.highlightAll({lineNumbers: <?js= this.navOptions.linenums || false ?>,  showMenu: true, enableDoclinks: true});
		} );
	</script>
