...
var qc = quickconnect('http://rtc.io/switchboard/', { room: 'reactive-test' });

// tell quickconnect that we want to work reactively
// i.e. respond to `onnegotiationneeded` events that are triggered
qc.reactive();
